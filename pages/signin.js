  ...
  return (
    <div className=" flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" action="http://localhost:5050/signin" method="POST">
        
          <input type="hidden" name="remember" defaultValue="true" />
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              <label htmlFor="email-address" className=" mb-1 font-bold block text-lg text-gray-600">
                Email address
              </label>
              <input
                id="email-address"
            ...
            <div>
              <label htmlFor="password" className="mb-1 mt-3 font-bold block text-lg text-gray-600">
                Password
              </label>
              <input
                id="password"
